...
<div>
    ...
    <ul class="list-style">
        ...
        <li>- write in english a little</li>
    </ul>
    ...
    <p class="p-style">To display your profile use your id in url</p> 
    <p class="code">http://localhost/nasa-web-project/editionprofil.php?id=</p> 
    <p class="p-style">and you will be directly redirected to your profile page</p>
